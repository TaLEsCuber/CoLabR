...
# 图像读取与预处理
R = io.imread('实验一\点扩散函数测量\参考物2.tif')
R_D = io.imread('实验一\点扩散函数测量\参考散斑2.tif')
U_D = io.imread('实验一\点扩散函数测量\未遮挡的散斑2.tif')
...
plt.axis('off')
plt.savefig('实验一/点扩散函数测量/点扩散函数_PSF2.png')  # 保存图像
# plt.show()
...
plt.axis('equal')
plt.savefig('实验一/点扩散函数测量/恢复图像_维纳滤波2.png')  # 保存图像
# plt.show()
...
plt.axis('equal')
plt.savefig('实验一/点扩散函数测量/阈值分割图像2.png')  # 保存图像
# plt.show()
...
plt.axis('off')
plt.savefig('实验一/点扩散函数测量/互相关系数图2.png')  # 保存图像
# plt.show()
