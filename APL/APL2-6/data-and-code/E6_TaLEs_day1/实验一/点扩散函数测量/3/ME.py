...
# 图像读取与预处理
R = io.imread('参考物.png')
R_D = io.imread('参考散斑.png')
U_D = io.imread('未遮挡的散斑.png')
...
plt.axis('off')
plt.savefig('点扩散函数_PSF.png')  # 保存图像
# plt.show()
...
plt.axis('equal')
plt.savefig('恢复图像_维纳滤波.png')  # 保存图像
# plt.show()
