...
# 图像读取与预处理
R = io.imread('不同工作距离\\50cm_2\参考物.png')
R_D = io.imread('不同工作距离\\50cm_2\参考散斑.png')
U_D = io.imread('不同工作距离\\50cm_2\未知物散斑.png')
...
plt.axis('off')
plt.savefig('不同工作距离\\50cm_2\点扩散函数_PSF.png')  # 保存图像
# plt.show()
...
plt.axis('equal')
plt.savefig('不同工作距离\\50cm_2\恢复图像_维纳滤波.png')  # 保存图像
# plt.show()
...
plt.axis('equal')
plt.savefig('不同工作距离\\50cm_2\阈值分割图像.png')  # 保存图像
# plt.show()
...
plt.axis('off')
plt.savefig('不同工作距离\\50cm_2\互相关系数图.png')  # 保存图像
# plt.show()
