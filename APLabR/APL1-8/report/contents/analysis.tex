...
\begin{table}
	...
	\begin{tabularx}{\textwidth}{|X|X|X|X|}
		...
		\hline
		Name： & 杨舒云\textbf{等人} & Student number：& 22344020\\
		\hline
...
从实验结果中，我们观察到：根据表格数据（\cref{tab:exp4-a-lens}），加装透镜后光束的光腰位置 \( z_0 \) 约为 277.78 mm，而透镜的位置在 0 mm。透镜的焦距为 \( f = 200 \) mm，那么如果光腰位于透镜焦点位置，则应该出现在 200 mm 处。然而，实验数据显示的光腰位置约为 277.78 mm，比透镜焦点更远。
